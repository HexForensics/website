...
--------------------*/
function setup() {
  const container = document.getElementById('particle-effect-container');
  if (!container) return;
  
  const containerRect = container.getBoundingClientRect();
  
  particleCanvas = createCanvas(containerRect.width, containerRect.height);
  particleCanvas.parent('particle-effect-container');
